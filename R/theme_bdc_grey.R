...
theme_bdc_grey <- function(base_size = 12, base_family = "",
        ...
        t <- theme(
            ...
            axis.ticks.length = grid::unit(quarter_line, units = "pt"),
            ...
            legend.spacing = grid::unit(0, units = "cm"),
            legend.key = element_rect(fill = "transparent", color = NA),
            legend.key.size = grid::unit(1.5, units = "lines"),
            legend.key.height = grid::unit(0.5, units = "lines"),
            legend.key.width = grid::unit(2.0, units = "lines"),
            legend.text = element_text(size = rel(0.6), hjust = 0, vjust = 0.5,
                                       color = medgrey),
            legend.text.align = NULL,
            legend.title = element_text(size = rel(0.6), face = "bold",,
                                        vjust = 0.8, hjust = 1, margin = margin(0, 20, 0, 0)),
            ...
            legend.box.margin = margin(0, 8, 0, 0, unit = "pt"),
            legend.box.background = element_blank(),
            legend.box.spacing = grid::unit(6, units = "pt"),
            ...
            panel.spacing = grid::unit(quarter_line, units = "pt"),
            ...
            strip.switch.pad.grid = grid::unit(0.1, units = "cm"),
            strip.switch.pad.wrap = grid::unit(0.1, units = "cm"),
